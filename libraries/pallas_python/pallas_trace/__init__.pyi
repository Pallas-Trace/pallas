...
class SequenceType:
    ...
    SEQUENCE_BLOCK: typing.ClassVar[
        SequenceType
    ]  # value = <SequenceType.SEQUENCE_BLOCK: 0>
    SEQUENCE_LOOP: typing.ClassVar[
        SequenceType
    ]  # value = <SequenceType.SEQUENCE_BLOCK: 1>
    __members__: typing.ClassVar[dict[str, SequenceType]]
...
class Thread:
    ...
    def __iter__(self) -> ...: ...
    def __repr__(self) -> str: ...
    def getSnapshotView(self, start: int, end: int) -> dict[Token, int]: ...
    def getSnapshotViewFast(self, start: int, end: int) -> dict[Token, int]: ...
    @typing.overload
...
class ThreadReader:
    ...
    def move_to_next_token(self, enter_sequence: bool = True, enter_loop: bool = True): ...
    def poll_current_token(self) -> tuple: ...
    def enter_if_start_of_block(
        self, exit_sequence: bool = True, exit_loop: bool = True
    ) -> bool: ...
    def exit_if_end_of_block(
        self, exit_sequence: bool = True, exit_loop: bool = True
    ) -> bool: ...
    def is_end_of_current_block(self) -> bool: ...
    def is_end_of_trace(self) -> bool: ...
...
def get_communication_matrix(
    trace: Trace, start: numpy.uint64, end: numpy.uint64
...
def get_communication_over_time(
    trace: Trace, timestamps: numpy.typing.NDArray[numpy.uint64], count_messages: bool
) -> numpy.typing.NDArray[numpy.uint64]:
    """
